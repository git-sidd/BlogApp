...
const SignUp = () => {
  ...
  return (
   <Box className="flex flex-col gap-2 justify-center items-center w-[400px] mx-auto shadow-2xl p-2 mt-20 md:mt-5">
     ...
     <TextField id="standard-basic" className='w-[60%] ' type='text' label="UserName" variant="standard" />
     ...
     <Button variant="contained"className='w-[100%] '>SignUp</Button>
     <div>----------or----------</div>
     <Button variant="outlined" className=''>Already have an account?</Button>
     </div>
